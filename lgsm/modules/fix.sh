...
apply_pre_start_fix=(arma3 armar ark av bt bo csgo cmw dst hw ins kf lo nmrih onset pvr ro rust rw samp sdtd sfc sof2 squad st tf2 terraria ts3 mcb mta unt vh wurm zmr)
